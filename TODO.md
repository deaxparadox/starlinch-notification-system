...
## In-Progress
- FEAT-20260822-1215 — Frontend foundation: Next.js app skeleton with (website) and (admin) route groups, shared API client, auth handling (spec: docs/specs/FEAT-20260822-1215-frontend-foundation.md)
