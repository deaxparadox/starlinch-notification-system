...
## Todo
- FEAT-20260822-1212 — Backend foundation: Django project, custom User model, JWT login/logout/refresh (access token in body, refresh token in httpOnly cookie), Docker + docker-compose for local dev (spec: docs/specs/FEAT-20260822-1212-backend-foundation.md)
- FEAT-20260822-1213 — Notifications core: Trigger/Template/NotificationLog/PushSubscription models, WhatsApp/Postmark/OneSignal adapters (ports & adapters pattern), fire_trigger() service layer
